...
module.exports = function (robot) {
    ...
    robot.on('issues.opened', function (context) { return __awaiter(_this, void 0, void 0, function () {
        var req;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    req = _a.sent();
                    if (req.isBot || req.isCollaborator)
                        return [2 /*return*/];
                    if (!(!req.labels.includes('question') && !req.body.match(/\b[A-Z0-9]{8}-(euc|apse)\b/))) return [3 /*break*/, 4];
                    req.label(req.config.feedback);
                    return [4 /*yield*/, req.save('issues.opened')];
                case 2:
                    _a.sent();
                    if (!req.config.no_debug_id) return [3 /*break*/, 4];
                    return [4 /*yield*/, context.github.issues.createComment(context.issue({ body: req.config.no_debug_id }))];
                case 3:
                    _a.sent();
                    _a.label = 4;
